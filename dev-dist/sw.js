...
define(['./workbox-76217345'], (function (workbox) { 'use strict';
  ...
  workbox.precacheAndRoute([{
    "url": "registerSW.js",
    "revision": "48f718199fee2d543ef0cf6472039226"
  }, {
    "url": "index.html",
    "revision": "0.7a0p35va8o8"
  }], {});
  workbox.cleanupOutdatedCaches();
  workbox.registerRoute(new workbox.NavigationRoute(workbox.createHandlerBoundToURL("index.html"), {
    allowlist: [/^\/$/]
  }));
  workbox.registerRoute(/^https:\/\/story-api\.dicoding\.dev\/v1\/stories.*/i, new workbox.StaleWhileRevalidate({
